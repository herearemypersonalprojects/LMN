    ...
    <div class="description">
      ...
      <div class="description-holder">
        <div class="text-block">
         ...
         <#if brandData.brandName == 'lastminute' || brandData.brandName == 'CGOS'  || brandData.brandName == 'SELECTOUR'>
              <script type="text/javascript">
                 <!--
                   document.write('<script language="JavaScript" type="text/javascript" src="http://avis.lastminute.com/?ctrl=rating&act=jsproductopinion&prodid=${productDisplayable.reference}s"></script>');
                 //-->
              </script>
          </#if>
        ...
        <div class="price-block">
          ...
          <a href="/${productDisplayable.seoUrl}" class="btn"><span>continuer <span class="ico_arrow-180">&nbsp;</span></span></a>
        </div>
      </div>
    </div>
