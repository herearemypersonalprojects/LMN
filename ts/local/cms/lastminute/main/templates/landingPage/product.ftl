...
<div id="offres_lp">
  ...
  <div class="lp_offer"<#if productIndex = landingPageProductSearchResponsebis.getProductsCount()> id="last"</#if>>
      ...
      <div class="details_image">
          <a href="http://voyage.lastminute.com/${productUrl}?intcmp=lp_${destination}">
      ...
      <div class="lp_details">
          ...
          <div class="lp_fr_button">
              <a href="http://voyage.lastminute.com/${productUrl}?intcmp=lp_${destination}">r&eacute;server</a>
          </div>
      </div>
  </div>
