...
set VERSION_CATALOGWAR=2.7.8-RC1
...
set CATALOGWAR=specific\havas\havas-b2c-catalog\%VERSION_CATALOGWAR%\havas-b2c-catalog-%VERSION_CATALOGWAR%.war
rmdir /s /q destination = %JBOSS_SERVER%\deploy\havas-b2c-catalog-%VERSION_CATALOGWAR%.war   
del /q /f   %JBOSS_SERVER%\deploy\havas-b2c-catalog-%VERSION_CATALOGWAR%.war
