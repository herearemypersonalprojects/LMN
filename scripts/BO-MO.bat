...
set VERSION_BO=11.3-SNAPSHOT
REM set VERSION_B2B=11.3-SNAPSHOT
...
set MO=orchestra\orchestra-ear\%VERSION_MO%\orchestra-ear-%VERSION_MO%.ear
if     exist %M2_LOCAL%\%MO% copy %M2_LOCAL%\%MO% %JBOSS_SERVER%\deploy
if not exist %M2_LOCAL%\%MO% copy %M2_REMOTE%\%MO% %JBOSS_SERVER%\deploy
